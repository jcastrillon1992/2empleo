...
const Hero = () => {
  ...
  return (
    <section className="pt-24 pb-16 bg-white min-h-screen fles items-center">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 left-1/2 tranform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-blue-50 to-purple-50 rounded-full blur-3xl opacity-20"/>
      </div>
    </section>
  );
};
